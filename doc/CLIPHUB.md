...
| **Paperclip CLI** | `penclip install`, `penclip publish`, `penclip cliphub sync` — built into Paperclip |
...
4. Run `penclip install cliphub:acme/lean-saas-shop`
...
2. Export: `penclip export --template my-agency`
3. Publish: `penclip publish cliphub my-agency`
...
3. Install just that agent: `penclip install cliphub:acme/senior-python-eng --agent`
...
- [ ] `penclip install cliphub:<publisher>/<slug>` CLI command
...
- [ ] `penclip cliphub sync` for bulk publishing
