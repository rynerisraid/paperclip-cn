...
> **Note:** If you used `npx` for setup, always use `npx penclip` to run commands. The `pnpm penclip` form only works inside a cloned copy of the Paperclip repository (see Local Development below).
