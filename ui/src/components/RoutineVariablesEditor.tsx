...
import { syncRoutineVariablesWithTemplate, type RoutineVariable } from "@penclipai/shared";
...
export function RoutineVariablesHint() {
  ...
  return (
    <div className="rounded-lg border border-dashed border-border/70 px-3 py-2 text-xs text-muted-foreground">
      {t("routineVariables.usePlaceholderHint", {
        defaultValue: "Use `{{placeholder}}` placeholders in the instructions to prompt for inputs when the routine runs.",
